...
class DreamGenerationMixin:
    ...
    def _sample(
        ...
        **model_kwargs,
        ...
        # print("[sicheng] (x.shape, max length, max new token):", x.shape, generation_config.max_length, generation_config.max_new_tokens)

        # Setting the cache position for prefill. Would need to be changed if use dynamic cache for decoding.
        # @sicheng: not use cache for now
        ...
        # print("[sicheng] attention_mask:", attention_mask.shape)
        ...
        for i in range(steps):
            ...
            if logits.shape[1] < L:
                print("[!!sicheng] should not happen when use_cache disabled")
